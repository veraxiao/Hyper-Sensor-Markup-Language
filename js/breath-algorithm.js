...
breathingAlgorithm = {
    ...
    exit: function(){
        var length = b.mediaStream.getTracks().length;
        for(var i = 0; i < length; i++){
            var track = b.mediaStream.getTracks()[i];
            track.stop();
        }
        b.audioContext.close();
        b.audioContext = 0;     
		...
		function goStream(stream){
            b.mediaStream = stream;
            var audioContext = b.audioContext;
			...
			javascriptNode.onaudioprocess = function () {
                ...
                //console.info("noise:",b.noiseLevel,"pow",b.pow);
