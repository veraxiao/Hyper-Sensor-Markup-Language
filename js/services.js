...
.factory('mySharedService', function($rootScope, $http, $q) {
  // Might use a resource here that returns a JSON array
    ...
    sharedService.htmlcontent = '<loc id="mobileMic" src="http://131.113.139.137/mic" scxml="upload/predefine.scxml" x="15" y="30"></loc>\n<loc id="drone" type="actuator" src="http://131.113.139.137:1337" x="15" y="40"></loc>\n<lnk function="LINEAR(drone.upspeed, mobileMic.data.pow, 1/70000);"></lnk>';
    ...
    sharedService.parseHtml = function(){
        ...
        if(locres)
        {
            ...
            {
                var loc = {tag:'', content:'', src:'', id:'', lat:99999, lng:99999, x:99999, y:99999, name:'', type:'', style:'', data:{}}; //changed by wu 2016-11-15
